                        ...
                        <div class="job-item p-4 mb-4">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    ...
                                    @if($firstImage)
                                    <img src="{{ asset('storage/images/' . basename($firstImage)) }}" alt="{{ $product->name }}" class="img-fluid mb-3 border zoom-image" style="max-height: 150px;" onclick="zoomImage(this)">
                                    @endif
                                    @endif
